# GeorefAuto_refatore Plugin

## Overview

GeorefAuto_refatore is a QGIS plugin for automatic georeferencing of aerial images using computer vision algorithms (RootSIFT, FLANN, and RANSAC). It allows you to georeference images by simply defining a bounding polygon that approximately contains the area where the image should be located.
...
6. Browse to the GeorefAuto_refatore.zip file and click "Install Plugin"
...
Via OSGeo4W Shell: install
python3 -m pip install opencv-python rasterio numpy psutil
